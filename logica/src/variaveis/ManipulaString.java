...
public class ManipulaString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Do 3ª em diante: " + email.substring(2));
		System.out.println("Primeira metade: " + email.substring(0, email.length()/2));
		
		// Exibir o servidor do email antes do @
		System.out.println("Usuário antes do @: " + email.substring(0, email.indexOf("@")));
		...
		// Comparando, usar sempmre equals e não ==
