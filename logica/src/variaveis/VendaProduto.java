...
public class VendaProduto {
	...
	public static void main(String[] args) {
		// Crie as variaveis para armazenar: nome do produto, código, valor e quantidade.
		...
		System.out.printf("Valor com Desconto: R$ %.2f\n", (total * 0.9));
		// o ideal é sempre fazer as operações matematicas nas variaveis e não na impressão.
		...
		int codigo2 = Integer.parseInt(JOptionPane.showInputDialog("Digite o código: "));
		...
		System.out.println("Valor Unitário: R$ " + valor2);
	}
