...
public class DesafioSimples {
	...
	public static void main(String[] args) {
		...
		if (idade > 17 && idade <= 70) {
			System.out.printf("Olá %s, atenção a mensagem abaixo!\n", nome);
			System.out.println("Você é Obrigado a votar, sua idade é " + idade);
		}
		
		if (idade >= 16 && idade <= 17 || idade > 70) {
			System.out.printf("Olá %s, atenção a mensagem abaixo!\n", nome);
			System.out.println(" Seu voto é facultativo, pois sua idade é " + idade);
		}
		
		if (idade < 16) {
			System.out.printf("Olá %s, atenção a mensagem abaixo!\n", nome);
			System.out.println("Proibido votar, sua idade é " + idade);
		}
