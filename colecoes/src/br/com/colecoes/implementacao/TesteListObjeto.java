...
public class TesteListObjeto {
	...
	public static void main(String[] args) {
		...
		// 2º Exibam somente os salários maior que 7000;
		
		for (Cargo objeto : lista) {
			System.out.println("Nome: " + objeto.getNome());
			System.out.println("Salário: R$ " + objeto.getSalario());
		}
		...
		for (Cargo objeto : lista) {
			...
			System.out.println("\n1º -> Salário: R$ " + totalSalario + "\n");
		
		for (Cargo objeto : lista) {
			if (objeto.getSalario() > 7000) {
				System.out.println("2º -> Nome: " + objeto.getNome());
				System.out.println("Salário: R$ " + objeto.getSalario());
			}
			// System.out.println("Nome: " + objeto.getNome());
			// System.out.println("Salário: R$ " + objeto.getSalario());
